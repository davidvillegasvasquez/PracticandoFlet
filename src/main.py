#Consumidor de api rest django, apiAutores.py
import flet as ft
import requests
...
def principal(pagina: ft.Page):
    ...
    def botonClickeado(e):
        ...
        try:
            respuestaGet = requests.get("http://127.0.0.1:8000/catalogo/api/autores/", headers={'Accept': 'application/json'}) #Forzamos la negociación de contenido en la renderización condicional de la vista de la api endpoint con el parámetro headers, porque no lo esta agarrando automáticamente.
            respuestaGet_2 = requests.get("http://127.0.0.1:8000/catalogo/api/libros/4", headers={'Accept': 'application/json'})
        ...
        # Algunos de los atributos y métodos más utilizados del objeto Response del modulo requests incluyen:
            ...
            resultadoGet = f"cantidad de autores:{diccionario['count']}, "
